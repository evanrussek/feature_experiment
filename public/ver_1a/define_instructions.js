...
var questions = ["How many types of aliens are in the task?", // 1
				...
				"Do the chances that certain aliens are behind doors change over the course of the task?", // 3
				"What does the silver number displayed on the first instruction screen indicate?", // 4
