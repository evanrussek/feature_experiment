...
function task(uid){
    ...
    var anx_aro_q = {
      ...
      questions: [
        {prompt: "Was short of breath", name: 'aa1', labels: scale_1},
        {prompt: "Felt dizzy or lightheaded", name: 'aa2', labels: scale_1},
        {prompt: "Hands were cold or sweaty", name: 'aa3', labels: scale_1},
        {prompt: "Hands were shaky", name: 'aa4', labels: scale_1},
        {prompt: "Had trouble swallowing", name: 'aa5', labels: scale_1},
        {prompt: "Had hot or cold spells", name: 'aa6', labels: scale_1},
        {prompt: "Felt like I was choking", name: 'aa7', labels: scale_1},
        {prompt: "Muscles twitched or trembled", name: 'aa8', labels: scale_1},
        {prompt: "Was trembling or shaking", name: 'aa9', labels: scale_1},
        {prompt: "Had a very dry mouth", name: 'aa10', labels: scale_1}
      ],
    ...
    var worry_q = {
      ...
      questions: [
        {prompt: "If I do not have enough time to do everything, I do not worry about it", name: 'worry1', labels: scale_1},
        {prompt: "My worries overwhelm me", name: 'worry2', labels: scale_1},
        {prompt: "I do not tend to worry about things", name: 'worry3', labels: scale_1},
        {prompt: "Many situations make me worry", name: 'worry4', labels: scale_1},
        {prompt: "I know I should not worry about things, but I just cannot help it", name: 'worry5', labels: scale_1},
        {prompt: "When I am under pressure I worry a lot", name: 'worry6', labels: scale_1},
        {prompt: "I am always worrying about something", name: 'worry7', labels: scale_1},
        {prompt: "I find it easy to dismiss worrisome thoughts", name: 'worry8', labels: scale_1},
        {prompt: "As soon as I finish one task, I start to worry about everything else I have to do", name: 'worry9', labels: scale_1},
        {prompt: "I never worry about anything", name: 'worry10', labels: scale_1},
        {prompt: "When there is nothing more I can do about a concern, I do not worry about it any more", name: 'worry11', labels: scale_1},
        {prompt: "I have been a worrier all my life", name: 'worry12', labels: scale_1},
        {prompt: "I notice that I have been worrying about things", name: 'worry13', labels: scale_1},
        {prompt: "Once I start worrying, I cannot stop", name: 'worry14', labels: scale_1},
        {prompt: "I worry all the time", name: 'worry15', labels: scale_1},
        {prompt: "I worry about projects until they are all done", name: 'worry16', labels: scale_1}
      ],
      randomize_question_order: false
    };
